...
class RegisterForm(FlaskForm):
    ...
    confirmpassword = PasswordField(validators=[DataRequired(), Length(min=4, max=20), EqualTo(password, message='Passwords must match')], render_kw={"placeholder": "Confirm Password"})
